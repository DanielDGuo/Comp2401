...
It will also create a text file with the same records that 
one should be able to read.  The text file name is patients.bin.txt.
output:
0 - if success
...
Copyright 2022Doron Nussbaum


Revisions:
----------

November 2022 Doron Nussbaum Initial version
*/ 
